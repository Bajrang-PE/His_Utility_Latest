...
const WidgitOptions = [
  ...
  { label: 'KPI', value: 'KPI' },
  // { label: 'Map', value: 'Criteria_Map' },
  // { label: 'News Ticker', value: 'News_Ticker' },
...
const graphPlugins = [
  { label: 'Highcharts (default)', value: 'highchart' },
...
const graphGuidelines = [
  ...
  'Please choose the graph generation library wisely, once widgit generated you CANNOT CHANGE the graph library',
  'You CANNOT change the widgit type from graph to any other type after saving or vice versa',
];
