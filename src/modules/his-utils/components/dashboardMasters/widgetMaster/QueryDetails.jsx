...
import WidgitMaster from './widgetPreview/WidgitMaster'
...
const QueryDetails = (props) => {
    ...
    return (
        <>
                        ...
                        <div className="col-sm-7 ps-0 align-content-center">
                            <div className="form-check form-check-inline">
                                <input
                                    ...
                                    type="radio"
                                    name="isQueryDataPreview"
                                    id="isQueryDataPreviewYes"
                                    value={'Yes'}
                                    onChange={handleRadioChange}
                                    checked={radioValues?.isQueryDataPreview === 'Yes'}
                                />
                            ...
                            <div className="form-check form-check-inline">
                                <input
                                    ...
                                    type="radio"
                                    name="isQueryDataPreview"
                                    id="isQueryDataPreviewNo"
                                    value={'No'}
                                    onChange={handleRadioChange}
                                    checked={radioValues?.isQueryDataPreview === 'No'}
                                />
            ...
            {radioValues?.isQueryDataPreview === 'Yes' &&
                <WidgitMaster handleValueChange={handleValueChange} handleRadioChange={handleRadioChange} radioValues={radioValues} values={values} setValues={setValues} singleData={singleData} errors={errors} setErrors={setErrors} {...{ rows, setRows, procedureRows, setProcedureRows }} dt={dt} selectedOptions={selectedOptions} setSelectedOptions={setSelectedOptions}/>
            }
        </>
    )
}
