...
import DragDropTabMaster from './dragdrop/DragDropTabMaster';
import Select from 'react-select'

const WidgetMapping = (props) => {
    const { handleValueChange, handleRadioChange, radioValues, values, widgetDrpData, setValues, rows, setRows, errors, setErrors, dt, setTablayout, tabLayout } = props;
                        ...
                        <div className="col-sm-7 ps-0 align-content-center">
                            <div className="form-check form-check-inline">
                                <input
                                    ...
                                    checked={radioValues?.isLayout === 'Yes'}
                                />
                            ...
                            <div className="form-check form-check-inline">
                                <input
                                    ...
                                    value={'No'}
                                    onChange={handleRadioChange}
                                    checked={radioValues?.isLayout === 'No'}
                                />
                                ...
                                <tr key={index}>
                                    <td>
                                        ...
                                        <Select
                                            ...
                                            placeholder="Select widget..."
                                            options={widgetDrpData}
                                            className="backcolorinput react-select-multi text-start"
                                            value={widgetDrpData?.find(dt => dt?.value == row.rptId)}
                                            onChange={(e) => { handleInputChange(index, 'rptId', e?.value); }}
                                        />
                                    </td>
                                    <td>
                                        <InputField
