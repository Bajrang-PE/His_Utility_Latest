...
const WidgetDash = React.memo(({ widgetDetail, presentWidgets, presentTabs, pk, isLayoutWithPreview, isPopup = false }) => {
    ...
    const renderWidget = (data) => {
        switch (data?.reportViewed) {
            ...
            case 'Graph': return <GraphDash widgetData={data} setWidgetData={setWidgetData} pkColumn={pkColumn} setPkColumn={handleSetPkColumn} isLayoutWithPreview={isLayoutWithPreview} presentTabs={presentTabs} isPopup={isPopup} pkConfig={pk} levelData={levelData} setLevelData={setLevelData} />;
